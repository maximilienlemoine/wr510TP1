...
const PlugInfo = {
    ...
    async handle(handlerInput) {
        ...
        try {
            ...
            const plugIp = await JSON.parse(response);
            console.log()

            return handlerInput.responseBuilder
                .speak(speakOutput)
                .speak(plugIp.data.device_status.wifi_sta.ip)
                .getResponse();
        } catch (error) {
...
const PlugPower = {
    ...
    async handle(handlerInput) {
        ...
        try {
            ...
            let state;
            (jsonResponse.isok) ? state = 'réussie' : state = 'non réussie'

            return handlerInput.responseBuilder
                .speak(speakOutput + ' opération '+ state)
                .getResponse();
        } catch (error) {
